...
export function Footer() {
  ...
  const defaults = {
    description:
      " ENDOKRINOLOGIYA SHIFOXONASI — Markaziy Osiyodagi zamonaviy jihozlangan xususiy ko'p tarmoqli klinika bo'lib, tashxis, davolash va murakkab yurak jarrohligi, ginekologiya, urologiya, qon-tomir, ortopediya va boshqa operatsiyalarni o'tkazish uchun mo'ljallangan.",
    description_ru:
      " ENDOKRINOLOGIYA SHIFOXONASI — современная многопрофильная университетская клиника в Центральной Азии, специализирующаяся на диагностике, лечении и проведении сложных операций.",
