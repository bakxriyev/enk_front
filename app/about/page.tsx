...
export default function AboutPage() {
  ...
  const detailedAboutUz = `Endokrinologiya, kardiologiya va nevrologiya shifoxonasi to‘g‘risida ma’lumot

Shifoxona 2024-yil 1-apreldan boshlab faoliyat yuritishni boshlagan bo‘lib, endokrinologiya, kardiologiya va nevrologiya bo‘limlari tashkil qilingan. 2024-yilda 688 nafar fuqaro davolangan bo‘lsa, 2025-yil 1-noyabr holatiga ko‘ra 1738 nafar bemor statsionar sharoitida davolanib chiqqan.

Shifoxonada 2, 3 va 4 o‘rinli palatalar tashkil qilingan bo‘lib, barcha palatalarda lyuks sharoitlar mavjud. Bemorlar dori-darmon, laboratoriya xizmati, UZI diagnostikasi, fizioterapiya hamda 3 mahal issiq ovqat bilan ta’minlanadi.

Shifoxona malakali kadrlar bilan to‘liq ta’minlangan.

2026-yilda shifoxona hududida 300 o‘ringa mo‘ljallangan qo‘shimcha bino qurilishi rejalashtirilgan. Yangi binoda jarrohlik, reanimatsiya, LOR va travmatologiya bo‘limlari xizmat ko‘rsatadi`

  const detailedAboutRu = `Информация об эндокринологической, кардиологической и неврологической больнице

Больница начала свою деятельность с 1 апреля 2024 года, в её составе организованы отделения эндокринологии, кардиологии и неврологии. В 2024 году лечение прошли 688 человек, а по состоянию на 1 ноября 2025 года в стационарных условиях пролечено 1738 пациентов.

В больнице организованы палаты на 2, 3 и 4 места, во всех палатах созданы условия класса «люкс». Пациенты обеспечиваются лекарственными средствами, лабораторными услугами, УЗИ-диагностикой, физиотерапевтическим лечением, а также трёхразовым горячим питанием.

Больница полностью укомплектована квалифицированными кадрами.

В 2026 году на территории больницы планируется строительство дополнительного здания, рассчитанного на 300 коек. В новом корпусе будут функционировать отделения хирургии, реанимации, ЛОР и травматологии`
